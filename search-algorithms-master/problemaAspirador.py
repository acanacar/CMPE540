...
class ProblemaAspirador(object):
    ...
    def acoes(self, estado):  # acoes => actions
        return ['Aspirar', 'Esquerda', 'Direita']

    def funcaoSucessora(self, estado, acao): # successor function

        lista = [['ELL', 'Aspirar', 'ELL'],
                 ['ELL', 'Esquerda', 'ELL'],  # Esquerda = Left
                 ['ELL', 'Direita', 'DLL'],   # right
        ...
        for i in lista:
            if estado == i[0] and acao == i[1]:  # estado state
                return i[2]
